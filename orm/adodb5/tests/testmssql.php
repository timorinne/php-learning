...
$conn->Connect('sqlsrv:server = tcp:tri-azure-sqlserver.database.windows.net,1433; Database = tri-php-study_db', 'tri', 'OhNoo8yu') or die('Fail');

$conn->debug =1;
$query = 'SELECT * FROM "tri-php-study_db".phptest.config';
